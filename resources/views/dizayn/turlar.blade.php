...
<section class="filter grid_12" style="padding: 15px 60px;">
    <form action="#" class="black">
      ...
      <div class="full">
        ...
        <input type="text" name="destination" id="search-input-fly" placeholder="All" />
      </div>
 ...
 <script>
  ...
  'ucus_noqtesi': $('#search-input-fly').val(),
  ...
  $.each(data.ser, function(index, value) {
    ...
    $('.results').append('<li class="grid_4"><a href="/tours/'+value.latin+'""><img src="'+a+'" alt="" style="width:100%;height:220px;"></a><h3><a href="/tours/'+value.latin+'" >'+value.tourName+'</a></h3><span class="price"><strong>'+value.price+'AZN</strong>/'+value.days+'gün</span><div><span><a href="/tours/'+value.latin+'">'+value.country+'</a></span><span class="stars"><img src="dizayn/img/star_full.png" alt="" /><img src="dizayn/img/star_full.png" alt="" /><img src="dizayn/img/star_full.png" alt="" /><img src="dizayn/img/star_half.png" alt="" /><img src="dizayn/img/star_empty.png" alt="" /></span><span>All inclusive</span></div></li>');
  console.log(a)
