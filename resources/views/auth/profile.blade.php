        ...
        <div class="panel-body">
          <div class="row">
            ...
            <div class="panel-footer">
              <a href="/{{ Auth::user()->id }}/profile/edit" data-original-title="Edit this user" data-toggle="tooltip" type="button" class="btn btn-sm btn-warning"><i class="glyphicon glyphicon-edit"></i></a>
              <span class="pull-right">
                ...
                <form action="/{{ Auth::user()->id }}/profile/destroy" method="post">
                  {{csrf_field()}}
