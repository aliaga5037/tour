...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/" class="logo">
      ...
      <span class="logo-lg"><b>Azerbaijan</b>Tour </span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-share"></i> <span>Girişlər</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i> Müştərilər</a></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2016 <a href="#">Midhat</a>.</strong> All rights
    reserved.
  </footer>
